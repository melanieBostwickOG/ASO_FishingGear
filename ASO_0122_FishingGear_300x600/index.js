...
p.nominalBounds = new cjs.Rectangle(0,0,890,825);
...
}).prototype = getMCSymbolPrototype(lib.image_1, new cjs.Rectangle(0,0,445,412.5), null);
...
}).prototype = getMCSymbolPrototype(lib.headline2_1, new cjs.Rectangle(0,0,300,600), null);
...
}).prototype = getMCSymbolPrototype(lib.brand4_1, new cjs.Rectangle(0,0,300,600), null);
...
}).prototype = getMCSymbolPrototype(lib.brand3_1, new cjs.Rectangle(0,0,300,600), null);
...
}).prototype = getMCSymbolPrototype(lib.brand2_1, new cjs.Rectangle(0,0,300,600), null);
...
}).prototype = getMCSymbolPrototype(lib.brand1_1, new cjs.Rectangle(0,0,300,600), null);
...
p.nominalBounds = new cjs.Rectangle(-13,-9,391.7,363.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-110,125,1,1,0,0,0,150,125);
	...
	this.instance_1.setTransform(198,431,0.5392,0.5392,0,0,0,198,431);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(59).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},52,cjs.Ease.elasticInOut).wait(36));

	// brand3
	this.instance_2 = new lib.brand3_1();
	this.instance_2.setTransform(101.1,431.1,0.5381,0.5381,0,0,0,101.1,431.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(41).to({_off:false},0).to({regX:101,regY:431,scaleX:1,scaleY:1,x:101,y:431,alpha:1},52,cjs.Ease.elasticInOut).wait(54));

	// brand2
	this.instance_3 = new lib.brand2_1();
	this.instance_3.setTransform(185.05,398.05,0.5479,0.5479,0,0,0,185.1,398.1);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(24).to({_off:false},0).to({regX:185,regY:398,scaleX:1,scaleY:1,x:185,y:398,alpha:1},52,cjs.Ease.elasticInOut).wait(71));

	// brand1
	this.instance_4 = new lib.brand1_1();
	this.instance_4.setTransform(122.05,399.05,0.5393,0.5393,0,0,0,122,399);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(10).to({_off:false},0).to({scaleX:1,scaleY:1,x:122,y:399,alpha:1},52,cjs.Ease.elasticInOut).wait(85));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("EgXbAu4MAAAgx/MAu3AAAMAAAAx/g");
	mask.setTransform(150,300.0027);

	// headline2
	this.instance_5 = new lib.headline2_1();
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:300,alpha:1},52,cjs.Ease.cubicOut).wait(95));

	// headline1
	this.instance_6 = new lib.headline1_1();
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(3).to({_off:false},0).to({y:300,alpha:1},52,cjs.Ease.cubicOut).wait(92));
	...
	// blue
	this.instance_8 = new lib.blue_1();
	this.instance_8.setTransform(150,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(147));

	// image
	this.instance_9 = new lib.Image_Zoom();
	this.instance_9.setTransform(132.05,85.55,1,1,0,0,0,163,112.9);
...
p.nominalBounds = new cjs.Rectangle(-110,276.4,427,334.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/blue.png?1643409610302", id:"blue"},
		{src:"images/brand1.png?1643409610302", id:"brand1"},
		{src:"images/brand2.png?1643409610302", id:"brand2"},
		{src:"images/brand3.png?1643409610302", id:"brand3"},
		{src:"images/brand4.png?1643409610302", id:"brand4"},
		{src:"images/cta.png?1643409610302", id:"cta"},
		{src:"images/headline1.png?1643409610302", id:"headline1"},
		{src:"images/headline2.png?1643409610302", id:"headline2"},
		{src:"images/image.jpg?1643409610302", id:"image"},
		{src:"images/logo.png?1643409610303", id:"logo"}
	],
	preloads: []
};
